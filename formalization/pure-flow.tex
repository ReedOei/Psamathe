...
\begin{tabular}{l r l l}
    ...
    $\mathcal{L}$, $\mathcal{K}$, $\mathcal{J}$ & \bnfdef & $\true$ \bnfalt $\false$ \bnfalt $n$ \bnfalt $x$ \bnfalt $[\overline{\mathcal{L}}]$ \bnfalt $\{ \overline{x : \tau \mapsto \mathcal{L}} \}$ & (simple locators) \\
                  & \bnfalt & $\mathcal{L} \to @x$ \bnfalt $\mathcal{L} \sends{\mathcal{L}}$ \bnfalt $\mathcal{L} \sends{\mathcal{Q} \tsuchthat f[\overline{T}](\overline{\mathcal{L}})}$ & (locator combinators) \\
    $\Stmt$ & \bnfdef & $\mathcal{L} \to \mathcal{L}$ \bnfalt $\mathcal{L} \to f[\overline{T}](\overline{\mathcal{L}}) \to \mathcal{L}$ & (flows) \\
...
\framebox{$\Gamma \flowproves \mathcal{L} : \tau \flowprovesout \Delta$} \textbf{Locator Typing}
...
\begin{tabular}{l r l l}
    $\ell$, $k$, $j$, $i$ & \bnfdef & $\loc(n)$ \\
    $\mathcal{L}$ & \bnfdef & $\ldots$ \bnfalt $\ell$
\end{tabular}

\framebox{$\angles{\Sigma, \mathcal{L}} \to \angles{\Sigma', \mathcal{L}'}$}

\begin{mathpar}
    \inferrule*[right=Var]{
    }{ \angles{ \Sigma, x } \to \angles{ \Sigma, \mu(x) } }

    \inferrule*[right=Field-Congr]{
...
\begin{mathpar}
    \inferrule*[right=Values-Congr-Src]{
        \angles{ \Sigma, \mathcal{L} } \to \angles{ \Sigma', \mathcal{L}' }
    }{ \angles{ \Sigma, \mathcal{L} \sends{\mathcal{K}} } \to \angles{ \Sigma', \mathcal{L'} \sends{\mathcal{K}} } }

    \inferrule*[right=Values-Congr-Sel]{
        \angles{ \Sigma, \mathcal{K} } \to \angles{ \Sigma', \mathcal{K}' }
    }{ \angles{ \Sigma, \ell \sends{\mathcal{K}} } \to \angles{ \Sigma', \ell \sends{\mathcal{K}'} } }

    \inferrule*[right=Values]{
        \rho(\ell) = \overline{V} \\
        \rho(k) = \overline{W} \\
        \overline{W} \subseteq \overline{V} \\
        \overline{j} = \setbuild{}{}
    }{ \angles{ \Sigma, \ell \sends{k} } \to \angles{ \Sigma, \overline{j} } }
\end{mathpar}

\begin{mathpar}
    \inferrule*[right=List-Congr]{
        \angles{ \Sigma, \mathcal{L} } \to \angles{ \Sigma', \mathcal{L}' }
    }{ \angles{ \Sigma, [ \overline{\ell}, \mathcal{L}, \overline{\mathcal{K}} ] } \to \angles{ \Sigma', [ \overline{\ell}, \mathcal{L}', \overline{\mathcal{K}} ] } }
...
\begin{mathpar}
    \inferrule*[right=Record-Congr]{
        \angles{ \Sigma, \mathcal{L} } \to \angles{ \Sigma', \mathcal{L}' }
    }{ \angles{ \Sigma, \{ \overline{x : \tau \mapsto \ell}, y : \sigma \mapsto \mathcal{L}, \overline{z : \pi \mapsto \mathcal{K}} \} }
       \to
       \angles{ \Sigma', \{ \overline{x : \tau \mapsto \ell}, y : \sigma \mapsto \mathcal{L}', \overline{z : \pi \mapsto \mathcal{K}} \} } }

    \inferrule*[right=Record]{
        k \not\in \dom(\rho)
    }{ \angles{ \Sigma, \{ \overline{x : \tau \mapsto \ell} \} }
       \to
       \angles{ \Sigma[\rho \mapsto \rho[k \mapsto \{ \overline{x : \tau \mapsto \ell} \}]], k } }
\end{mathpar}
...
\begin{mathpar}
    \inferrule*[right=Bool]{
        ...
        \\
        \ell \not\in \dom(\rho)
    }{ \angles{ \Sigma, b } \to \angles{ \Sigma[\rho \mapsto \rho[\ell \mapsto b]], \ell } }

    \inferrule*[right=Nat]{
        \ell \not\in \dom(\rho)
    }{ \angles{ \Sigma, n } \to \angles{ \Sigma[\rho \mapsto \rho[\ell \mapsto n]], \ell } }
\end{mathpar}
