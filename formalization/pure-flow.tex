...
\begin{tabular}{l r l l}
    ...
    $\Loc$ & \bnfdef & $\true$ \bnfalt $\false$ \bnfalt $n$ & (literals) \\
           ...
           & \bnfalt & $\Loc[\Loc]$ \bnfalt $\Loc[\mathcal{Q} \tsuchthat f[\overline{T}](\overline{L})]$ \bnfalt $\consume$ \bnfalt $\newc~t$ & (locators) \\
    Flow & \bnfdef & $\Loc \to \Loc$ \bnfalt $\Loc \to f[\overline{T}](\overline{x}) \to \Loc$ & (flows) \\
