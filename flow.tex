...
\begin{tabular}{l r l l}
    ...
    $\Stmt$ & \bnfdef & $E$ \bnfalt $\revert(E)$ \bnfalt $F$ \bnfalt $\ifS~E~\thenS~S$ \bnfalt $\var~x:\tau$ \bnfalt $\var~x:\tau := E$ \bnfalt $S;S$ & (statements) \\
...
\begin{mathpar}
    ...
    }{ \Gamma \flowproves \ell : (S \sends{f} D)~\wf \flowprovesout \update(\Delta, D, (\mathcal{Q} \wedge \mathcal{R}) \oplus \Delta(D)) }
