...
We distinguish between two kinds of calls: views and transactions.
A view call is guaranteed to not change any state in the receiver, while a transaction may change the state.
\begin{mathpar}
    ...
    \inferrule*[right=Tx-Call]{
        ...
        \and
        \Gamma, \this : C, x : D \flowproves \overline{y : \tau} \flowprovesout \Delta, \this : C, x : D
    }{ \Gamma, \this : C, x : D \flowproves x.m(\overline{y}) : \sigma \flowprovesout \Delta, \this : C, x : D }
\end{mathpar}
...
\begin{mathpar}
    ...
    }{ \Gamma \proves \newc~C :: \curlys{\fields(C)} \flowsto_{\every} ~ C }
...
\begin{mathpar}
    ...
    \inferrule*[right=Wf-Constructor]{
        \this : C, \overline{x : \tau} \flowproves S~\ok \flowprovesout \Delta
        \and
        \forall x : \tau \in \Delta. \lnot(\tau~\asset)
