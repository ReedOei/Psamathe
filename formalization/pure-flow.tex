...
\begin{mathpar}
    ...
    \inferrule*[right=Field]{
        ...
        \lnot(\tau~\immutable)
        \\
        \fields(\tau) = \overline{z : \sigma}
        \\
        y : \mathcal{R}~T \in \overline{z : \sigma}
    }{ \Gamma \flowproves x.y : \mathcal{R}~T \flowprovesout \Gamma }
...
\begin{mathpar}
    ...
    \inferrule*[right=Resolve-Record]{
        ...
        \\
        \Sigma' = \Sigma[\rho \leftarrow \rho[\overline{\mu(y) \leftarrow []}, \overline{\ell \leftarrow \rho(\mu(y))}, k \leftarrow \{ \overline{x : \tau \mapsto \ell} \} ]]
    ...
    \inferrule*[right=Resolve-Bool]{
        ...
        \\
        \ell \not\in \dom(\rho)
    }{ \resolve(\Sigma, b) = (\Sigma[\rho \leftarrow \rho[\ell \leftarrow b]], \ell) }
\end{mathpar}
