...
\begin{mathpar}
    ...
    }{ \Sigma, \putS(\mathcal{V}, \consume) \evaluates \Sigma }

    \inferrule*[right=Put-Var]{
        \Sigma(A) = \mathcal{W}
    }{ \angles{ \Sigma, \putS(\mathcal{V}, A) } \evaluates \Sigma[A \leftarrow \mathcal{V} \mathcal{W}] }

    \inferrule*[right=Put-VarDef]{
    }{ \Sigma, \putS(\mathcal{V}, \var~A : T) \evaluates \Sigma[A \leftarrow \mathcal{V}] }

    \inferrule*[right=Flow-Every]{
        \Sigma(\mathcal{S}) = \mathcal{V}
        \\
        \Sigma(\mathcal{D}) = \mathcal{W}
    }{ \angles{\Sigma, \mathcal{S} \to \mathcal{D}} \evaluates \angles{\Sigma[\mathcal{S} \leftarrow []], \putS(\mathcal{V}, \mathcal{D}) } }
    ...
    }{ \Sigma, (\mathcal{S} \sends{\mathcal{Q}~\suchthat~f(\overline{x})} \mathcal{D}) \to \Sigma[\mathcal{S} \leftarrow \mathcal{V} \setminus \mathcal{U}, \mathcal{D} \leftarrow \mathcal{W} \mathcal{U}] }
