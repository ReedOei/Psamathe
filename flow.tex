...
\begin{tabular}{l r l l}
    ...
    $\Stmt$ & \bnfdef & $x.m(\overline{x})$ \bnfalt $\revert(E)$ \bnfalt $F$ \bnfalt $\tryS~S~\catchS(x : \tau)~S$ \bnfalt $\ifS~x~\thenS~S$ \bnfalt $\var~x:\tau$ \bnfalt $\var~x:\tau := E$ \bnfalt $S;S$ & (statements) \\
...
\begin{definition}
    ...
    Define $\emptyq \leq \any \leq \,\, \exactlyone \leq \nonempty \leq \every$.
...
\begin{mathpar}
    ...
    }{ \Gamma, \this : C \flowproves \this.m(\overline{y}) : \sigma \flowprovesout \Delta }
...
\begin{definition}
    ...
    For types,
    \[
        \mathcal{Q}~T_\mathcal{Q} < \mathcal{R}~T_\mathcal{R} \iff T_\mathcal{Q} = T_\mathcal{R} \tand \mathcal{Q} \neq \any \tand \mathcal{R} = \any
    \]
...
\begin{mathpar}
    ...
    }{ \Gamma \flowproves (\ell : S \sends{s} D)~\wf \flowprovesout \update(\Delta, D, \Delta(D) \oplus \min(\mathcal{Q}, \mathcal{R})) }
    ...
    \inferrule*[right=Wf-Var-Def-Init]{
        \Gamma \flowproves E : \mathcal{R}~T \flowprovesout \Gamma
    }{ \Gamma \flowproves (\var~x : \mathcal{Q}~T := E)~\wf \flowprovesout \Gamma, x : \mathcal{R}~T }
    ...
    \inferrule*[right=Wf-Try]{
        ...
        \and
        \Gamma, x: \tau \flowproves S_2~\wf \flowprovesout \Xi
    ...
    }{ \Gamma \flowproves E~\wf \flowprovesout \Delta }
