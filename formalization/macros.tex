...
% NOTE: For some reason the tipa package doesn't seem to like mathpartir, so this a workaround.
\newcommand{\langNamePronounce}{/s\char"251 m\char"251 \char"03B8 i/}
