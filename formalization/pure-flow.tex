...
\begin{mathpar}
    ...
    }{ \angles{ \Sigma, \mathcal{L}.x } \to \angles{ \Sigma', \mathcal{L}'.x } }
    ...
    \inferrule*[right=Loc-Val-Src-Congr]{
        \angles{ \Sigma, \mathcal{L} } \to \angles{ \Sigma'', \mathcal{L}'' }
    }{ \angles{ \Sigma, \mathcal{L}[\mathcal{L}'] } \to \angles{ \Sigma'', \mathcal{L}''[\mathcal{L}'] } }

    \inferrule*[right=Loc-Val-Sel-Congr]{
        \angles{ \Sigma, \mathcal{L}' } \to \angles{ \Sigma'', \mathcal{L}'' }
    }{ \angles{ \Sigma, \ell[\mathcal{L}'] } \to \angles{ \Sigma'', \ell[\mathcal{L}'] } }
