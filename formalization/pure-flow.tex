...
\begin{mathpar}
    ...
    \inferrule*[right=Put-Var]{
        ...
        \\
        \mathcal{W} + \mathcal{V} \neq \revert
    }{ \angles{ \Sigma, \putS(\mathcal{V}, A) } \evaluates \Sigma[\rho \mapsto \rho[\mu(A) \mapsto \mathcal{W} + \mathcal{V}]] }

    \inferrule*[right=Put-Var-Fail]{
        \rho(\mu(A)) = \mathcal{W}
        \\
        \mathcal{W} + \mathcal{V} = \revert
    }{ \angles{ \Sigma, \putS(\mathcal{V}, A) } \evaluates \angles{\Sigma, \revert} }
...
\begin{mathpar}
    ...
    }{ \Sigma, (\mathcal{S} \sends{\mathcal{Q}~\suchthat~f(\overline{x})} \mathcal{D}) \to \angles{ \Sigma'[\rho' \mapsto \rho'[\ell \mapsto \rho'(\ell) - \mathcal{U}]], \putS(\mathcal{U}, \mathcal{D}) } }
