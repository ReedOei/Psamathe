...
\begin{align*}
    F[\Gamma] &= \setbuild{x : \tau \in \Gamma}{\lnot (F~\empties~x:\tau) \tand \lnot (F~\fills~x:\tau)} \\
              &\cup \setbuild{x : \emptyq~\tau}{x : \tau \in \Gamma, F~\empties~x:\tau} \\
              &\cup \setbuild{x : \fullq~\tau}{x : \tau \in \Gamma, F~\fills~x:\tau}
\end{align*}
