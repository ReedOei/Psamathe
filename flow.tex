...
\begin{tabular}{l r l l}
    ...
    $E$ & \bnfdef & $\mathcal{V}$ \bnfalt $\mathcal{S}$ \\
...
\reed{Contract types should be assets by default, transformers are assets if their output type is an asset type?}
...
\begin{mathpar}
    ...
    \inferrule*[right=New]{
        \contract~C~\{ \overline{F} ~ (\oncreate(\overline{x : \tau})~S) ~  \overline{T} \}
        \and
