...
\framebox{$\Gamma \proves \mathcal{S}~\provides~\tau$} \textbf{Source Typing}
...
\begin{mathpar}
    ...
    }{ \Gamma, S : \tau \proves S~\provides~\tau }
...
\begin{mathpar}
    ...
    }{ \Gamma \proves x~\selects_{\exactlyone}~\exactlyone~\mathcal{C}~\tau }

    \inferrule*[right=Select-Col]{
        \Gamma \flowproves x : \mathcal{Q}~T \flowprovesout \Gamma
    }{ \Gamma \proves x~\selects_{\mathcal{Q}}~\mathcal{Q}~T }
...
\begin{mathpar}
    ...
    \inferrule*[right=Wf-Flow]{
        \Gamma \proves A~\provides_\mathcal{Q}~\mathcal{C}~T
        \and
        \Gamma \proves s~\selects_\mathcal{R}~\demote(\mathcal{C}~T)
        \and
        \Delta = \update(\Gamma, A, \Gamma(A) \ominus \mathcal{R})
        \\
        \Delta \flowproves f : \mathcal{S}~\mathcal{C}~\exactlyone~(\tau \transforms \sigma) \flowprovesout \Delta
        \and
        \min(\mathcal{Q}, \mathcal{R}) < \every
        \and
