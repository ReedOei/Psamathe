...
\lstdefinelanguage{flow}{
    ...
    keywords=[3]{map,linking,set,list,multiset,address,uint256,uint,ether,record,table,string,bytes,nat,bool},
    keywordstyle=[3]\color{Emerald}\itshape,
    keywords=[4]{nonempty,any,every,empty,exactly,one,msg,this,in,new,or,and,not,total,consume,zip},
