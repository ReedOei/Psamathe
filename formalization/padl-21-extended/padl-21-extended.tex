...
\begin{mathpar}
    ...
    \inferrule*[right=Flow-List-Empty]{
    }{ \angles{ \Sigma, [ \tau ; \cdot ] \to (m,k) } \to \Sigma }

    \inferrule*[right=Flow-List-Nonempty]{
...
\reed{This is only necessary for the proofs. TODO: Update this to match the versions from the Isabelle formalization.}
