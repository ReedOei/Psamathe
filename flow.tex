...
\begin{mathpar}
    ...
    \inferrule*[right=Lookup-NoConsume]{
    }{ \Gamma, x : \tau \proves x : \demote(\tau) }

    \inferrule*[right=Check-Transformer]{
    ...
    }{ \Gamma, S : \tau \flowsto \sigma \flowproves S : \tau \flowsto \sigma \flowproveout \Gamma, S : \mathcal{Q}~\sigma }

    \inferrule*[right=Flow-Storage]{
    }{ \Gamma, S : \mathcal{Q}~\tau \flowproves S : \tau \flowsto \tau \flowproveout \Gamma, S : \mathcal{Q}~\sigma }

    \inferrule*[right=Flow]{
        \Gamma \flowproves S : \tau \flowsto \sigma \flowproveout \Delta
        \and
        \Delta \proves f~\selects~\demote(\sigma)
        \and
        \Delta \flowproves D : \sigma \flowsto \pi \flowproveout \Xi
    }{ \Gamma \proves S \sends{f} D : \tau \flowsto \pi \flowproveout \Xi }
