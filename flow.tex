...
\framebox{$\Gamma \proves x : \tau$} \textbf{View Typing}
\begin{mathpar}
...
\framebox{$\Gamma \proves x ~\selects~ \tau$} \textbf{Selectors}
\begin{mathpar}
    ...
    }{ \Gamma \proves s~\selects~\tau }

    \inferrule*[right=Select-Quant]{
        \Gamma, x : \tau \proves p : \boolt
    }{ \Gamma \proves \mathfrak{q}~x~\suchthat~p~\selects~\tau }
\end{mathpar}

\framebox{$\Gamma \flowproves x : \tau \flowproveout \Delta$} \textbf{Linear Expression Typing}
\begin{mathpar}
    \inferrule*[right=Lookup]{
    }{ \Gamma, x : \tau \flowproves x : \tau \flowproveout \Gamma }

    \inferrule*[right=View]{
        \Gamma \proves x : \tau
        \and
        \lnot (\tau ~ \asset)
...
\framebox{$\Gamma \proves x :: \tau \flowsto \sigma$} \textbf{Flow Typing}
\begin{mathpar}
    ...
    \inferrule*[right=Flow]{
        ...
        \and
        \Gamma \proves f~\selects~\demote(\sigma)
        \and
