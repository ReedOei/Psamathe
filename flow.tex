...
\begin{definition}
    ...
    Define $\emptyq \leq \any \leq \,\, ! \leq \nonempty \leq \infty$, based on the amount of resources that every selector quantifier is \textbf{guaranteed} to select.
...
\begin{mathpar}
    ...
    \inferrule*[right=Store-New]{
        \contract~C~\{ \overline{\mathcal{D}} \}
        \and
        (\oncreate(\overline{x : \tau})~S) \in \overline{\mathcal{D}}
        \and
        \Gamma \flowproves \overline{y : \tau} \flowprovesout \Gamma
