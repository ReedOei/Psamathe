...
\newcommand{\flowfrom}[1]{\stackrel{#1}{\mathrel{\raisebox{-0.3em}{\resizebox{1em}{!}{$\leftharpoondown$}}}}}
\newcommand{\flowto}[1]{\stackrel{#1}{\mathrel{\raisebox{-0.3em}{\resizebox{1em}{!}{$\rightharpoonup$}}}}}
\newcommand{\flowfromto}[1]{\stackrel{#1}{\mathrel{\raisebox{-0.4em}{\resizebox{1em}{!}{$\rightleftharpoons$}}}}}
\newcommand{\with}{\text{with}\xspace}

\newcommand{\putS}{\textbf{\texttt{put}}\xspace}
\newcommand{\evaluates}{\to}
\newcommand{\compat}{\leftrightarrow}
\newcommand{\updateElem}{\text{updateElem}\xspace}
...
\newcommand{\emptyVal}{\text{empty}\xspace}
\newcommand{\amount}{\text{amount}\xspace}
\newcommand{\exactType}{\text{exactType}\xspace}

\newcommand{\types}{\textsc{Type}\xspace}

% \newcommand{\langName}{LANGUAGE-NAME\xspace}
\newcommand{\langName}{Psamathe\xspace}
\newcommand{\langNamePronounce}{/\textipa{sAmATi}/}
...
\newcommand{\sends}[1]{\xrightarrow{#1}}

\newcommand{\isAsset}{\text{isAsset}\xspace}
...
\newcommand{\assetT}{\texttt{asset}\xspace}
\newcommand{\consumableT}{\texttt{consumable}\xspace}
\newcommand{\immutableT}{\texttt{immutable}\xspace}

\newcommand{\flowError}{\textbf{\texttt{error}}\xspace}

\newcommand{\dom}{\textbf{\texttt{dom}}\xspace}
\newcommand{\img}{\textbf{\texttt{img}}\xspace}
...
\newcommand{\zip}{\textbf{\texttt{zip}}\xspace}
...
\newcommand{\exactlyone}{\textbf{\texttt{one}}\xspace}
...
\newcommand{\resolvable}{\textbf{\texttt{resolvable}}\xspace}
\newcommand{\matches}{\textbf{\texttt{matches}}\xspace}

\newcommand{\elemtype}{\text{elemtype}\xspace}
...
\newcommand{\modifiers}{\text{modifiers}\xspace}
...
\newcommand{\update}{\text{update}\xspace}

\newcommand{\typeof}{\textbf{\texttt{typeof}}\xspace}

\newcommand{\pass}{\textbf{\texttt{pass}}\xspace}
...
\newcommand{\demoteT}{\text{demote}\xspace}
