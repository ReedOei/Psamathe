...
Additionally, $\fullq~\emptyq \equiv \one$, $\fullq~\fullq \equiv \fullq$, \reed{$\emptyq~\fullq \equiv \emptyq$?}
...
\begin{mathpar}
    \inferrule*[right=Empty]{
        ...
        \and
        f = \everything \lor \mathcal{Q} = \one
    }{ \Gamma \proves (x \sends{f} D)~\consumesarr~x }
\end{mathpar}
