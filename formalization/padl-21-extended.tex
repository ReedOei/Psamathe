...
\emph{Locators} are expressions access parts of complex structures while maintaining the safety properties of \langName.
In Figure~\ref{fig:erc20-transfer-flow}
}
...
Any extra value in the bid (used to mask the true value of the bid), will be returned to the bidder upon request.
